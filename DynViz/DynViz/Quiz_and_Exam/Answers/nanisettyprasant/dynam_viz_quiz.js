...
var main = function(error, raw_data) {
  ...
  bars.attr("width", xScale.bandwidth())
      ...
      .on("mouseover", function() {
         d3.selectAll(".bar").classed("hovered", false).style("fill-opacity",document.getElementById("hoveru").value);
         d3.selectAll(".bar").classed("unhovered", true);
         d3.select(this).classed("hovered", true).style("fill-opacity",document.getElementById("hovero").value);
