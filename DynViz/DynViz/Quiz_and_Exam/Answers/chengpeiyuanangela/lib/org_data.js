...
// {"type":"Topology","objects":{
      "Uganda_admin_2014_WGS84":{
        "type":"GeometryCollection","bbox":[
          29.572546464000027,-1.4818227099999604,35.02303503100008,4.232322233000052
        ],"geometries":[
          {
            "type":"Polygon","properties":{
              "ADM0_NAME":"Uganda","ADM1_NAME":"Kaabong","ADM2_NAME":"Dodoth","Adm_Region":"Northern","Shape_Leng":4.14503592749,"Shape_Area":0.591806324246},"arcs":[[0,1,2,3]]},{"type":"Polygon","properties":{
...
// {"type":"Topology","objects":{
      "Boundaries - Community Areas (current)":{
        "type":"GeometryCollection","geometries":[
          {
            "type":"Polygon","properties":{
              "community":"DOUGLAS","area":"0.0","shape_area":"46004621.1581","perimeter":"0.0","comarea_":"0","area_num_1":"35","area_numbe":"35","comarea_id":"0","shape_len":"31027.0545098"},"arcs":[[0,1,2,3,4]]},{"type":"Polygon","properties":{"community":"OAKLAND","area":"0.0","shape_area":"16913961.0408","p

tmp_map[0].properties.community
"DOUGLAS"

// However, it missed the following errors:
MONTCLARE versus Montclaire
WASHINGTON HEIGHTS versus Washington Height
OHARE versus O'Hare
...
/*
// And below is the actual code to make the hook up (the code above will just print out to console):

tmp_map.forEach(function(elem) {
  elem.details = tmp_data.find(function(d) {
    return d['CA Name'].toUpperCase() === elem.properties.community;
  });
});
